...
DanceApp::DanceApp() : GraphicsApp(1280,768, "So You Think Ants Can Dance") {
    ...
    ballet_special2_.TrimFront(10);
    ballet_special2_.TrimBack(50);
    ballet_special2_.CalcRelativeTranslations();

    ballet_special3_.LoadFromAMC(Platform::FindFile("05_13.amc", searchPath_), *ballet_ant_.skeleton_ptr());
    ballet_special3_.TrimFront(75);
    ballet_special3_.TrimBack(30);
    ballet_special3_.CalcRelativeTranslations();
    
    ballet_special4_.LoadFromAMC(Platform::FindFile("05_18.amc", searchPath_), *ballet_ant_.skeleton_ptr());
    ballet_special4_.TrimFront(800);
    ballet_special4_.TrimBack(30);
    ballet_special4_.CalcRelativeTranslations();

    ballet_special5_.LoadFromAMC(Platform::FindFile("05_11.amc", searchPath_), *ballet_ant_.skeleton_ptr());
    //ballet_special5_.TrimFront(275);
    //ballet_special5_.TrimBack(30);
